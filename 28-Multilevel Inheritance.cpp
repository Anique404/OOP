...
Rectangle::Rectangle():Circle(),l(3),w(2){
	cout<<"Default constructor of Rectangle is called"<<endl;
}

Rectangle::Rectangle(int ll):Circle(),l(ll),w(2){
	cout<<"1 Parameterized constructor of Rectangle is called"<<endl;
}

Rectangle::Rectangle(int ll,int ww):Circle(),l(ll),w(ww){
	cout<<"2 Parameterized constructor of Rectangle is called"<<endl;
}

Rectangle::Rectangle(int ll,int ww,int rr):Circle(rr),l(ll),w(ww){
	cout<<"3 Parameterized constructor of Rectangle is called"<<endl;
}

Rectangle::Rectangle(const Rectangle & r):Circle(r),l(r.l),w(r.w){
	cout<<"Copy constructor of Rectangle andCircle  is called"<<endl;
}
